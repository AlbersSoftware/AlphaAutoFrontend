<script>
    ...
    export let tabs = [
        ...
        { name: "Order Parts", link: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" },
        // { name: "Contact", link: "" },
        // {name: '', link: ''},
    ];
</script>
...
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Alpha AutoWorks</b> <span class=""></span>
    </h1>
    <img src="src/images/alphalogo.png" alt="Logo" class="mx-auto h-10">
    <div class="sm:flex items-center gap-4 hidden">
        ...
        >
            <div
                class="absolute top-0 right-full w-full h-full bg-violet-400 opacity-20 group-hover:translate-x-full z-0 duration-200"
            />
            <h4 class="relative z-9">Tech Support</h4>
        </button>
    </div>
</header>